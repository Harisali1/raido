...
class DriverController extends Controller
{
        ...
        try {
            ...
            if (count($vendors) > 0) {
                return makeJsonResponse(
                    'Success', [
                        'vendors' => $this->calculateDistance(request('distance'), request('time'), $vehicleType, $vendors)
                    ]
                );
            }
    ...
    protected function calculateDistance($distance, $time, VehicleType $vehicleType, $vendors)
    {
