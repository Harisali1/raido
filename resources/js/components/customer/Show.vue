        ...
        <div class="page-content">
            <div class="page-head">
                <div class="page-title">
                    <h1>Customer Profile | Account</h1>
                </div>
            </div>
                    ...
                    <div class="profile-sidebar">
                        <div class="portlet light profile-sidebar-portlet bordered">
                            ...
                            <div class="profile-userbuttons">
                                <button type="button" class="btn btn-circle green btn-sm" v-if="data.status == 1">ON
                                </button>
                                <button type="button" class="btn btn-circle red btn-sm" v-if="data.status ==  0">OFF
                                </button>
                            </div>
                            ...
                            <!--                                </div>-->
                            <!--                                <div class="col-md-6 col-sm-4 col-xs-6">-->
                            <!--                                    <div class="uppercase profile-stat-title"> 67</div>-->
...
export default {
    ...
    methods: {
        ...
        submit: function () {
            ...
            axios.post(`/admin/customer/${this.item.id}`, this.buildFormData())
                .then(() => {
                    ...
                    setTimeout(() => {
                        window.location.href = `/admin/customer/${this.item.id}`;
                    }, 1000);
                })
                .catch(err => {
                    this.isActive = false;
        ...
        changePassword: function () {
            ...
            this.isActive = true;
            this.submitting = true;
            axios.post(`/admin/customer/updatePassword/${this.item.id}`, this.password)
                .then(() => {
