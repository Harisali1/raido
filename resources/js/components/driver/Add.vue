            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Create Driver With Vehicle</span>
                    </div>
                </div>
                <div class="portlet-body form">
                    <div class="form-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label style="margin-bottom: 15px;">Vendors</label>
                                    <select2
...
<!--                            <div class="col-md-4">-->
<!--                                <div class="form-group">-->
<!--                                    <label style="margin-bottom: 15px;">License No</label>-->
<!--                                    <div class="input-group">-->
<!--                                        <span class="input-group-addon">-->
<!--                                            <i class="fa fa-credit-card"></i>-->
<!--                                        </span>-->
...
<!--                                                    </AutoComplete>-->
                    ...
                    <div class="form-body">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Ex # 2000"
                                               v-mask="'######'"
                        ...
                        <div class="row" style="margin-top:20px;">
                            <div class="col-md-3">
                                <label style="margin-bottom: 15px;">Vehicle Image</label>
