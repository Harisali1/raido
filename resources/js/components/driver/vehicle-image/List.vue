...
export default {
    ...
    methods: {
        ...
        submit: function () {
            ...
            axios.post(`/admin/driver_vehicle_images/${this.vehicles.id}`, this.data)
                .then(() => {
                    console.log(this.data);
                    this.$alertify.success("Vehicle Image Uploaded Successfully!");
                    setTimeout(() => {
                        window.location.href = `/admin/driver_vehicle_images/${this.vehicles.id}`;
                    }, 1000)
                })
                .catch(err => {
        ...
        deleteVehicleDocument: function (id, key) {
            axios.delete(`/admin/driver_vehicle_images/${id}`)
                .then(() => {
