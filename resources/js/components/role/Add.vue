            ...
            <div class="portlet light bordered">
                ...
                <div class="portlet-body form">
                                ...
                                <div class="col-md-3" v-for="(permission, key) in permissions">
                                    <div class="mt-checkbox-list">
                                        <input type="checkbox" name="permissions[]"
                                               @change="choosePermission($event, permission)">&nbsp;
                                        <span class="" v-text="permission.label"></span>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-actions noborder">
                        <button @click="submit" v-text="submitting ? 'Submitting...' : 'Submit'" class="btn blue" :disabled="isActive">
                            Submit
                        </button>
                        <a href="/admin/role">
...
export default {
    ...
    methods: {
        ...
        submit: function () {
            ...
            this.isActive = true;
            axios.post('/admin/role', this.data)
                .then(() => {
                    this.$alertify.success("Role Created Successfully!");
                    setTimeout(() => {
