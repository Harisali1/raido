        ...
        <div class="page-content">
            <div class="page-head">
                <div class="page-title">
                    <h1>Sub Admin Profile | Account</h1>
                </div>
            </div>
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="/admin/sub_admin">Sub Admim</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
...
<!--                                <img :src="getFullUrl(data.image)" class="img-responsive" alt="">-->
                            </div>
...
<!--                                <button type="button" class="btn btn-circle green btn-sm" v-if="data.status === 1">ON</button>-->
<!--                                <button type="button" class="btn btn-circle red btn-sm" v-if="data.status === 0">OFF</button>-->
<!--                            </div>-->
...
<!--                            </div>-->
                            <div class="profile-usermenu">
                                <ul class="nav">
                                    ...
                                    <li class="active">
                                        <a href="javascript:void(0)">
                                            <i class="fa fa-phone"></i> {{ data.contact }} </a>
                                    </li>
<!--                                    <li>-->
<!--                                        <a href="javascript:void(0)">-->
<!--                                            <i class="icon-credit-card"></i> {{ data.cnic }} </a>-->
<!--                                    </li>-->
                                </ul>
                            </div>
                        </div>
                                            ...
                                            <div class="tab-pane active" id="tab_1_1">
                                                <form role="form" action="#">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" v-model="data.contact" readonly
                                                               class="form-control">
                                                    </div>
<!--                                                    <div class="form-group">-->
...
export default {
    ...
    methods: {
        ...
        //     axios.post(`/admin/sub_admin/${this.item.id}`, this.buildFormData())
        //         .then(() => {
        //             this.$alertify.success("Profile Picture Updated Successfully!");
        //             setTimeout(() => {
        //                 window.location.href = `/admin/sub_admin/${this.item.id}`;
        //             }, 1000);
        //         })
        //         .catch(err => {
        //             this.isActive = false;
        ...
        changePassword: function () {
            ...
            this.isActive = true;
            this.submitting = true;
            axios.post(`/admin/sub_admin/updatePassword/${this.item.id}`, this.password)
                .then(() => {
