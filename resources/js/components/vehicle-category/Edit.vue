    ...
    <div class="page-content-wrapper">
        <div class="page-content">
            ...
            <ul class="page-breadcrumb breadcrumb">
                ...
                <li>
                    <a href="/admin/vendor">Vehicle Category</a>
                    <i class="fa fa-circle"></i>
                </li>
                <li>
            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Edit Vehicle Category</span>
                    </div>
                </div>
...
export default {
    ...
    methods: {
        ...
        submit: function () {
            ...
            axios.post(`/admin/vehicle_category/${this.item.id}`, this.buildFormData())
                .then(() => {
