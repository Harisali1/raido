<template>
    <div class="center modal fade" id="penaltyAddModel" tabindex="-1"
         role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Penalty Charge Here</h5>
...
export default {
    ...
    methods: {
        submit: function () {
            ...
            // this.isActive = true
            axios.post(`/admin/vendor/penalty/${this.vendorId}`, this.data)
                .then(() => {
                    this.$alertify.success("Charge Penalty Successfully!");
                    $("#penaltyAddModel").modal('hide');
                    this.data.credit = '';
                    this.data.reason = '';
                })
                .catch(err => {
