            ...
            <div class="portlet light bordered">
                <div class="portlet-title">
                    <div class="caption font-red-sunglo">
                        ...
                        <span class="caption-subject bold uppercase">Create Fare Calculation</span>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Base Fare"
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Per Km"
                                               v-model="data.per_km">
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="number" class="form-control" placeholder="Enter Per Hours"
                            ...
                            <div class="flex flex-wrap -mx-3 mb-4">
                                <table class="table">
                                    ...
                                    <tbody>
                                    <tr v-for="(size, key) of data.fareCalculation">
                                            <input type="hidden" class="form-control" placeholder="Enter Label"
                                                   v-model="size.vehicle_type_id">
...
export default {
    ...
    methods: {
        ...
        updateSettings: function () {
            ...
            let url = "/vendor/base_fare_calculation";
            this.updating = true
            this.isDisabled = true
            axios.post(url, this.data)
                .then(() => {
                    this.$alertify.success('Base Fare Added Successfully')
                    setTimeout(() => {
