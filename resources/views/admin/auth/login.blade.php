    ...
    <div class="card card0 border-0">
        <div class="row">
            <div class="offset-1 col-lg-4">
                <div class="card1 pb-5">
                    <div class="row"><img src="{{ asset('assets/pages/img/logos/logo-111x33.png') }}" class="logo"></div>
            ...
            <div class="col-lg-6">
                <div class="card2 card border-0 px-4 py-5">
                    <div class="row mb-4 px-3">
                        <h6 class="mb-0 mr-4 mt-2">Admin Login</h6>
                    ...
                    <form method="POST" action="{{ route('admin.login') }}">
                        @csrf
                        @error('email')
                        <span class="alert alert-danger mb-4" role="alert">
        ...
        <div class="bg-blue py-4">
            <div class="row px-3"><small class="ml-4 ml-sm-5 mb-2">Copyright &copy; 2019. All rights reserved.</small>
                <div class="social-contact ml-4 ml-sm-auto"><span class="fa fa-facebook mr-4 text-sm"></span> <span class="fa fa-google-plus mr-4 text-sm"></span> <span class="fa fa-linkedin mr-4 text-sm"></span> <span
