        ...
        <div class="m-heading-1 border-green m-bordered">
            <div class="portlet-title">
                <div class="caption font-red-sunglo">
                    ...
                    <span class="caption-subject bold uppercase">Search Vendor</span>
                </div>
            </div>
                                ...
                                <div class="col-md-6">
                                    <div class="btn-group">
                                        <a href="{{ route('admin.vendor.create') }}">
                                            <button id="sample_editable_1_new" class="btn sbold green"> Add New Vendor
